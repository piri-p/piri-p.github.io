...
Argilla is open-source data annotation platform. It can be used for use cases like collecting annotated data for training our own Encoder model or tweaking LLM judge prompt.
