...
Network Security > Firewall policies > Create a firewall rule
* Direction: Ingress
...
Install [Docker](https://docs.docker.com/engine/install/ubuntu/#install-using-the-repository) then [Docker Compose](https://docs.docker.com/compose/install/linux/#install-using-the-repository)
```bash
